...
export HILIC_DATA_FILE_PATH=/workspace/Graphormer-RT/my_data/HILIC_ft/DM_Finetune_train.csv
export HILIC_METADATA_PATH=/workspace/Graphormer-RT/my_data/HILIC_ft/HILIC_metadata.pickle
...
CUDA_VISIBLE_DEVICES=0 fairseq-train \
  ...
  --num-classes 1 \
  --attention-dropout 0.1 --act-dropout 0.05 --dropout 0.05 \
  --optimizer adam --adam-betas '(0.9, 0.999)' --adam-eps 1e-8 --clip-norm 1.0 --weight-decay 0.01 \
